...
public class Briskula extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_briskula);
    ...
    {
        Intent i = new Intent(this, Briskula_createtim.class);
    ...
    public void Zapocni( View v)
    {
        if(count<2)
        {
            ...
            Intent intent = new Intent(this, Briskula_start.class);
